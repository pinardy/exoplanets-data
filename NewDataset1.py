...
# INSTRUCTIONS: Build and run to obtain the graph for new_dataset_1
# The time taken for no transit and transit will be printed
...
print "no eclipse:",np.mean(periodnoorbit)
print "eclipse:",np.mean(periodorbit)
print "change in flux:",1-np.min(y1)

# Obtained all of the phases and fluxes for the dips
